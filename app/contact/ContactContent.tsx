  ...
  return (
    <>
      <PageHeader
        ...
        title={[t.contact.l1, t.contact.l2]}
        ...
        <div className="mx-auto max-w-site px-6 md:px-10">
          <div className="grid grid-cols-12 gap-6 md:gap-8">
            <div className="col-span-12 md:col-span-7">
              <SectionHeader number="07" label={t.contact.reachUs} />
            ...
            <aside className="col-span-12 md:col-span-4 md:col-start-9">
              ...
              <div className="mt-10 border-t border-line pt-8">
                ...
                <p className="mt-4 text-body text-paper">{t.footer.hours}</p>
              </div>
              <div className="mt-10 border-t border-line pt-8">
                <div className="font-mono text-mono-label uppercase opacity-60">
                  {t.contact.social}
      ...
      <section className="relative w-full border-t border-line py-24 md:py-32">
        <div className="mx-auto max-w-site px-6 md:px-10">
          <ContactForm />
        </div>
      </section>
